...
export function isSimulateInput(v: unknown): v is SimulateInput {
  ...
  if (
    ...
    typeof (o.button_reply as Record<string, unknown>).context_wa_message_id ===
      "string"
  )
    return true;
  if (
    ...
    typeof (o.list_reply as Record<string, unknown>).context_wa_message_id ===
      "string"
  )
    return true;
  return false;
        ...
        changes: [
          {
            ...
            value: {
              ...
              contacts: [
                input.name
                  ? { profile: { name: input.name }, wa_id: waId }
                  : { wa_id: waId },
              ],
              messages: [message],
            },
